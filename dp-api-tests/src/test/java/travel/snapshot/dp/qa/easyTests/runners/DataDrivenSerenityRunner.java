package travel.snapshot.dp.qa.easyTests.runners;

/**
 * Created by Jiri  Zelezny on 5/4/2017.
 */
...
/**
 *
 * This class is just a copy of DataDrivenTestRunner from EasyTest project.
 *
 * Only one thing was changed - it extends SerenityRunner instead of BlockJUnit4ClassRunner. That enables the test suites to have EasyTest functionality and generate Serenity reports as well.
 *
 * It is not a very nice solution (it's in fact really ugly) but it works. Question to find alternatives was raised in Serenity project - https://github.com/serenity-bdd/serenity-core/issues/779
 */
public class DataDrivenSerenityRunner extends SerenityRunner {

    /**
     * An instance of logger associated with the test framework.
     */
    private final Logger LOG = LoggerFactory.getLogger(org.easetech.easytest.runner.DataDrivenTestRunner.class);
    ...
    /**
     * Look at {@link org.easetech.easytest.runner.DataDrivenTestRunner} for details.
     *
     * @see org.easetech.easytest.runner.DataDrivenTestRunner
     * @param klass
     * @throws InitializationError
     */
    public DataDrivenSerenityRunner(Class<?> klass) throws InitializationError {
