...
Feature: Properties-Users access check feature
  ...
  Background:
    ...
    Given The following property exists with random address and billing address for user "0d829079-48f0-4f00-9bec-e2329a8bdaac"
  ...
  Scenario: Second level entities - User sees only users of the same property he owns
    When Relation between user "userWithProp" and property "p1_code" is activated
