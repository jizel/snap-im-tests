package travel.snapshot.dp.qa.cucumber.steps.identity.applications;
...
public class ApplicationsStepsdef {
    ...
    public void Application_With_Name_Is_Deleted(UUID applicationId) throws Throwable {
    ...
    public void Application_With_Id_Is_Updated_With_Data(String applicationName, List<ApplicationUpdateDto> applications)
            throws Throwable {
        UUID applicationId = applicationSteps.resolveApplicationId(applicationName);
    ...
    public void Application_with_id_is_updated_with_data_if_updated_before(UUID applicationId,
    ...
    public void Application_WithIdIsGot(UUID applicationId) {
    ...
    public void Application_versions_are_created_for_application_with_id(UUID applicationId,
    ...
    public void application_version_for_application_with_id_is_deleted(UUID appVersionId) {
        applicationVersionSteps.deleteApplicationVersion(appVersionId);
    }

    @Then("^Application version with id \"([^\"]*)\" does not exist$")
    public void Application_version_with_same_id_does_not_exist(UUID applicationVersionId) {
    ...
    public void Application_version_with_id_for_application_with_id_is_updated_with_data(UUID appVersionId,
                                                                                         UUID applicationId, List<ApplicationVersionDto> applicationVersion) throws Throwable {
    ...
    public void Updated_application_version_with_id_for_application_with_id_has_data(UUID appVersionId,
                                                                                     UUID applicationId, List<ApplicationVersionDto> applicationVersion) throws Throwable {
    ...
    public void Application_version_with_id_for_application_with_id_is_updated_with_data_with_invalid_etag(
            UUID appVersionId, List<ApplicationVersionDto> applicationVersion) throws Throwable {
    ...
    public void Application_version_with_id_for_application_with_id_is_got(UUID appVersionId) {
    ...
    public void Applications_commercial_subscriptions_for_application_id_is_got(UUID applicationId) {
    ...
    public void applicationVersionIsRequestedDirectly(UUID versionId) throws Throwable {
