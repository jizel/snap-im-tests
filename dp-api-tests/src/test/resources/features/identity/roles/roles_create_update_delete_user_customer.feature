...
Feature: Roles create update delete user customer
  ...
  Background:
    ...
    Given The following roles exist
      ...
      | Role name 1 | optional description 1 | 03000000-0000-4444-8888-000000000000 |
      | Role name 2 | optional description 2 | 03000000-0000-4444-8888-000000000000 |
      | Role name 3 | optional description 3 | 03000000-0000-4444-8888-000000000000 |
