...
public class TestDims {
  ...
  public void testDimChannelLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from Channels where ModificationTimestamp > %1$s");
    ...
    followUpListToSource.add(withStartDate(
        "select count(distinct Name) from Channels where ModificationTimestamp > %1$s"));
  ...
  public void testDimChannelCategoryLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from ChannelCategories where ModificationTimestamp > %1$s");
    // Need to subtract 1 because currently there are initial data added in
    // the table
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct Description) from ChannelCategories where ModificationTimestamp > %1$s"));
  ...
  public void testDimChannelSegmentLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from ChannelSegments where ModificationTimestamp > %1$s");
    // Need to subtract 1 because currently there are initial data added in
    // the table
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct ChannelSegmentName) from ChannelSegments where ModificationTimestamp > %1$s"));
  ...
  public void testDimMarketCategoryLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from MarketCategories where ModificationTimestamp > %1$s");
    // Need to subtract 1 because currently there are initial data added in
    // the table
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct MarketCategoryName) from MarketCategories where ModificationTimestamp > %1$s"));
  ...
  public void testDimMarketSegmentLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from MarketSegments where ModificationTimestamp > %1$s");
    // Need to subtract 1 because currently there are initial data added in
    // the table
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct MarketSegmentName) from MarketSegments where ModificationTimestamp > %1$s"));
  ...
  public void testDimPropertyLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from Properties where ModificationTimestamp > %1$s");
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct PropertyName) from Properties where ModificationTimestamp > %1$s"));
  ...
  public void testDimRatePlanLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from RatePlans where ModificationTimestamp > %1$s");
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct RatePlanCode) from RatePlans where ModificationTimestamp > %1$s"));
  ...
  public void testDimRoomTypeLoad() throws Exception {
    String sqlQueryForSource =
        withStartDate("select count(ID) from RoomTypes where ModificationTimestamp > %1$s");
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct Name) from RoomTypes where ModificationTimestamp > %1$s"));
    followUpListToSource.add(
        withStartDate("select sum(NumberOfRooms) from RoomTypes where ModificationTimestamp > %1$s"));
  ...
  public void testDimRateShoppingPropertyLoad() throws Exception {
    String sqlQueryForSource =
        "select count(distinct rrs.id) from RateRankShoppingProperties rrs left join Properties p on  rrs.ID = p.RateRankShoppingPropertyID";
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(
        "select count(distinct rrs.PropertyName) from RateRankShoppingProperties rrs left join Properties p on rrs.ID = p.RateRankShoppingPropertyID");
  ...
  public void testDimSnapshotLoad() throws Exception {
    String sqlQueryForSource = withStartDate(
        "select count(ID) from FCSGridSnapshotsMetadata where SnapshotCreationTimestamp > %1$s");
    // Need to subtract 1 because currently there are initial data added in
    // the table
    ...
    List<String> followUpListToSource = new ArrayList<String>();
    followUpListToSource.add(withStartDate(
        "select count(distinct Caption) from FCSGridSnapshotsMetadata where SnapshotCreationTimestamp > %1$s"));
