Feature: Eventing_identity_module
  ...
  then is customer is created and then notification is checked.
    ...
    When Customer is created with random address
      ...
      | Eventing  company | ev1@tenants.biz | ev1t | salesforceid_event_1 | CZ0000333 | true           | +420123456789 | http://www.snapshot.travel | Europe/Prague |
  ...
  Scenario: Eventing customer deleted
    ...
    Given The following customers exist with random address
      | companyName              | email            | code  | salesforceId             | vatId      | isDemoCustomer | phone         | website                    | timezone      |
      | Delete Eventing  company | dev1@tenants.biz | dev1t | salesforceid_del_event_1 | CZ00001111 | true           | +420123456789 | http://www.snapshot.travel | Europe/Prague |
  ...
  Scenario: Eventing customer updated
    ...
    Given The following customers exist with random address
      | companyName              | email            | code  | salesforceId             | vatId      | isDemoCustomer | phone         | website                    | timezone      |
      | Update Eventing  company | uev1@tenants.biz | uev1t | salesforceid_del_event_1 | CZ00011111 | true           | +420123456789 | http://www.snapshot.travel | Europe/Prague |
