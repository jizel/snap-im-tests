Feature: customers_properties_get
  ...
  Scenario Outline: Filtering list of customer properties
    ...
    Given Relation between property with code "filter_list_prop_cust_p1_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-01-01" to "2030-02-31"
    Given Relation between property with code "filter_list_prop_cust_p2_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-02-01" to "2030-03-31"
    Given Relation between property with code "filter_list_prop_cust_p3_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-03-01" to "2030-04-31"
    Given Relation between property with code "filter_list_prop_cust_p4_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-04-01" to "2030-05-31"
    Given Relation between property with code "filter_list_prop_cust_p5_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-05-01" to "2030-06-31"
    Given Relation between property with code "filter_list_prop_cust_p6_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-06-01" to "2030-07-31"
    Given Relation between property with code "filter_list_prop_cust_p7_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-07-01" to "2030-08-31"
    Given Relation between property with code "filter_list_prop_cust_p8_code" and customer with code "filter_list_c1t" exists with type "anchor" from "2015-08-01" to "2030-09-31"
