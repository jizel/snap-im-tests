Feature: Api subscriptions validation
  ...
  Scenario Outline: Object update - api_subscription - invalid values
    ...
    Examples:
      ...
      | 5c6f61ff-810c-43da-96e2-ff6c8c9b8b2f | isActive             | 59          | -1                                   | #                                                 |
      | 5c6f61ff-810c-43da-96e2-ff6c8c9b8b2f | applicationVersionId | 59          | invalid_application_version_id       | #                                                 |
      | 5c6f61ff-810c-43da-96e2-ff6c8c9b8b2f | applicationVersionId | 59          | b595fc9d-f5ca-45e7-a15d-c8a97108d884 | #                                                 |
  ...
  Scenario Outline: Object update - api_subscription - valid values
    ...
    Examples:
      ...
      | 5c6f61ff-810c-43da-96e2-ff6c8c9b8b2f | isActive             | 9999999                              |
