...
Feature: Users customer roles CRUD
  ...
  Scenario: Assigning role to user customer
    ...
    When User "defaultSnapshotUser" assigns role "a318fd9a-a05d-42d8-8e84-42e904ace123" to relation between user "default1" and customer "06000000-0000-4444-8888-000000000001"
  ...
  Scenario: Assigning role to user property
    ...
    Given The following properties exist with random address and billing address for user "default1"
     ...
     | 721a284b-9dc4-48e6-8353-6ec55b89e291 | salesforceid_1 | p1_name      | p1_code      | http://www.snapshot.travel | p1@tenants.biz | true           | Europe/Prague | 06000000-0000-4444-8888-000000000001 |
    Given The following roles exist
      | id                                   | roleName    | description            | applicationId                                   |
      | a318fd9a-a05d-42d8-8e84-42e904ace123 | user_role_1 | optional description 1 | 03000000-0000-4444-8888-000000000000 |
  ...
  Scenario: Assigning role to user property set
    ...
    Given The following property sets exist for customer with id "06000000-0000-4444-8888-000000000001" and user "default1"
  ...
  Scenario: Get, update, delete user
    ...
    Given Relation between user "default1" and customer "06000000-0000-4444-8888-000000000001" is deleted
