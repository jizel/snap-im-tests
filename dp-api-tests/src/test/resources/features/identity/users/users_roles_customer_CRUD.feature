...
Feature: Users customer roles CRUD
  ...
  Background:
    ...
    Given The following users exist for customer "1234fd9a-a05d-42d8-8e84-42e904ace123"
      ...
      | customer | default1 | Default1  | User1    | def1@snapshot.travel | Europe/Prague | cs-CZ   | 2048b11e-eff2-477c-b322-015bbd931e46 |
      | customer | default2 | Default2  | User2    | def2@snapshot.travel | Europe/Prague | cs-CZ   | 2048b11e-eff2-477c-b322-015bbd931e47 |
