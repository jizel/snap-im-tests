Feature: Customers create update delete
  ...
  Scenario Outline: Validate that customer regions belong to the correct country
    ...
    Examples:
     ...
     # Australia regions
      | AU      | Ashmore and Cartier Islands       | custcode51 | mail51@mail.com |
      | AU      | Australian Antarctic Territory    | custcode52 | mail52@mail.com |
      | AU      | Australian Capital Territory      | custcode53 | mail53@mail.com |
      | AU      | Christmas Island                  | custcode54 | mail54@mail.com |
      | AU      | Cocos (Keeling) Islands           | custcode55 | mail55@mail.com |
      | AU      | Coral Sea Islands                 | custcode56 | mail56@mail.com |
      | AU      | Heard Island and McDonald Islands | custcode57 | mail57@mail.com |
      | AU      | Jervis Bay Territory              | custcode58 | mail58@mail.com |
      | AU      | New South Wales                   | custcode59 | mail59@mail.com |
      | AU      | Norfolk Island                    | custcode60 | mail60@mail.com |
      | AU      | Northern Territory                | custcode61 | mail61@mail.com |
      | AU      | Queensland                        | custcode62 | mail62@mail.com |
      | AU      | South Australia                   | custcode63 | mail63@mail.com |
      | AU      | Tasmania                          | custcode64 | mail64@mail.com |
      | AU      | Victoria                          | custcode65 | mail65@mail.com |
    # Canada regions
      | CA      | Ontario                           | custcode66 | mail66@mail.com |
      | CA      | Quebec                            | custcode67 | mail67@mail.com |
      | CA      | Nova Scotia                       | custcode68 | mail68@mail.com |
      | CA      | New Brunswick                     | custcode69 | mail69@mail.com |
      | CA      | Manitoba                          | custcode70 | mail70@mail.com |
      | CA      | British Columbia                  | custcode71 | mail71@mail.com |
      | CA      | Prince Edward Island              | custcode72 | mail72@mail.com |
      | CA      | Saskatchewan                      | custcode73 | mail73@mail.com |
      | CA      | Alberta                           | custcode74 | mail74@mail.com |
      | CA      | Newfoundland and Labrador         | custcode75 | mail75@mail.com |
      | CA      | Northwest Territories             | custcode76 | mail76@mail.com |
      | CA      | Yukon                             | custcode77 | mail77@mail.com |
      | CA      | Nunavut                           | custcode78 | mail78@mail.com |
  ...
  Scenario Outline: Checking error codes for regions
    ...
    Examples:
      ...
      | AU      | bg_region        | propcode15 | mail16@mail.com | 422           | 42202       |
      | AU      | VictoriaRegion   | propcode15 | mail17@mail.com | 422           | 42202       |
      | AU      | TheGreatTasmania | propcode15 | mail18@mail.com | 422           | 42202       |
      | CA      | Yukon region     | propcode15 | mail18@mail.com | 422           | 42202       |
      | CA      | TheGreatYukon    | propcode15 | mail18@mail.com | 422           | 42202       |
