...
# GET /review/analytics/property/{property_id}/popularity_index_rank
  ...
  Scenario Outline: Get trip advisor analytics data from API for a given wrong granularity
    ...
    Examples:
      ...
      | popularity_index_rank | 99000199-9999-4999-a999-999999999999 | mm          | 2015-12-03 | 2015-12-03 |
      | popularity_index_rank | 99000199-9999-4999-a999-999999999999 | 1dd         | 2015-12-03 | 2015-12-03 |
  ...
  Scenario Outline: Get specific analytics data from API for a given granularity
    When Get "<metric>" for list of properties for customer "<property_id>" with since "<since>" until "<until>" and granularity "<granularity>"
  ...
  Scenario Outline: Checking data corectness for analitics
    ...
    Examples:
      ...
      | popularity_index_rank | /xxx.json       | 99000199-9999-4999-a999-999999999999 | day         | 2015-12-03 | 2015-12-03 |
      | popularity_index_rank | /xxx.json       | 99000199-9999-4999-a999-999999999999 | week        | 2015-11-12 | 2015-12-03 |
      | popularity_index_rank | /xxx.json       | 99000199-9999-4999-a999-999999999999 | month       | 2015-08-26 | 2015-12-03 |
