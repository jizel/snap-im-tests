Feature: User groups property sets
  ...
  Background:
    ...
    Given The following customers exist with random address
      ...
      | 67adbc2d-f6ad-4e6a-9ed8-8ba93c430481 | UserGroupsCustomer | ug@tenants.biz | ug1  | CZ10000001 | +420123456789 | Europe/Prague | true           |
    ...
    Given The following property sets exist for customer with code "ug1"
  ...
  Scenario Outline: Relationship creation between user group and property - invalid
    ...
    Examples:
      ...
      | d11352e6-44ff-45bb-bd51-28f62ca8f33c | /null     | 400            | 63   | # notExisting property_set_id     |
