Feature: Roles create update delete user customer
  ...
  Scenario Outline: Checking error codes for creating role
    ...
    Examples:
      ...
      | /messages/identity/roles/create_role_missing_application_id.json   | POST   | identity | /identity/user_customer_roles | 400        | 53          |
      | /messages/identity/roles/create_role_missing_role_name.json        | POST   | identity | /identity/user_customer_roles | 400        | 53          |
      | /messages/identity/roles/create_role_not_existing_application.json | POST   | identity | /identity/user_customer_roles | 400        | 63          |
      | /messages/identity/roles/create_role_not_recognized_field.json     | POST   | identity | /identity/user_customer_roles | 400        | 56          |
      | /messages/identity/roles/create_role_not_unique_role_name.json     | POST   | identity | /identity/user_customer_roles | 400        | 62          |
      | /messages/identity/roles/create_role_not_valid_json.json           | POST   | identity | /identity/user_customer_roles | 400        | 51          |
