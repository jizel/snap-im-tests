Feature: properties_validation
  ...
  Background:
    ...
    | /address/address_line1 | String    | true     | [a-zA-Z0-9]{12}                                                    | /null           | [a-zA-Z0-9]{13}  |
    | /address/address_line2 | String    | false    | [a-zA-Z0-9]{12}                                                    | /null           | [a-zA-Z0-9]{13}  |
    | /address/city          | String    | true     | [a-zA-Z0-9]{12}                                                    | /null           | [a-zA-Z0-9]{13}  |
    | /address/zip_code      | String    | true     | [a-zA-Z0-9]{12}                                                    | /null           | [a-zA-Z0-9]{13}  |
    | /address/country       | String    | true     | US                                                                 | xx              | [a-zA-Z0-9]{13}  |
