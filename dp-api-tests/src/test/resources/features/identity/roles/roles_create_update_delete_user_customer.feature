...
Feature: Roles create update delete user customer
  ...
  Background:
    ...
    Given The following roles exist
      ...
      | Role name 1 | optional description 1 | 11111111-0000-4000-a000-111111111111 |
      | Role name 2 | optional description 2 | 11111111-0000-4000-a000-111111111111 |
      | Role name 3 | optional description 3 | 11111111-0000-4000-a000-111111111111 |
