Feature: Api subscription get
  ...
  Scenario Outline: Getting list of api subscriptions with valid query parameters
    ...
    Given The following properties exist with random address and billing address
      | propertyId                           | salesforceId    | propertyName | propertyCode | website                    | email           | isDemoProperty | timezone      |
      | 23fe2b58-de46-4330-b361-482f07286cce | salesforceid_1  | p1_list      | p1_list      | http://www.snapshot.travel | p1@tenants.biz  | true           | Europe/Prague |
      | 5e334ae2-c3a1-486e-b7e7-dd3209656188 | salesforceid_2  | p2_list      | p2_list      | http://www.snapshot.travel | p2@tenants.biz  | true           | Europe/Prague |
      | 4701c194-e39d-46fd-b70f-44dd15a82278 | salesforceid_3  | p3_list      | p3_list      | http://www.snapshot.travel | p3@tenants.biz  | true           | Europe/Prague |
      | b9e2b6cc-4453-4935-a8c5-8763ae7873d7 | salesforceid_4  | p4_list      | p4_list      | http://www.snapshot.travel | p4@tenants.biz  | true           | Europe/Prague |
      | 0567c8c6-523d-4c2b-9941-eb4bd7b61a7d | salesforceid_5  | p5_list      | p5_list      | http://www.snapshot.travel | p5@tenants.biz  | true           | Europe/Prague |
      | ac1e411c-1c68-4178-9871-62b4728c6c9d | salesforceid_6  | p6_list      | p6_list      | http://www.snapshot.travel | p6@tenants.biz  | true           | Europe/Prague |
      | a5fb70c4-4be6-4eb4-bb54-87e56d86e751 | salesforceid_7  | p7_list      | p7_list      | http://www.snapshot.travel | p7@tenants.biz  | true           | Europe/Prague |
      | d320aaad-d465-4be5-97f5-41254bf19038 | salesforceid_8  | p8_list      | p8_list      | http://www.snapshot.travel | p8@tenants.biz  | true           | Europe/Prague |
      | 4faa9765-c16c-4a63-9df9-8c60cb5303cf | salesforceid_9  | p9_list      | p9_list      | http://www.snapshot.travel | p9@tenants.biz  | true           | Europe/Prague |
      | ad51c66f-330b-4201-8374-92f138a7629d | salesforceid_10 | p10_list     | p10_list     | http://www.snapshot.travel | p10@tenants.biz | true           | Europe/Prague |
      | 24284ba4-6d29-4a5a-9187-363e168fac9a | salesforceid_11 | p11_list     | p11_list     | http://www.snapshot.travel | p11@tenants.biz | true           | Europe/Prague |
      | 3ad7fec4-e484-497d-bcc4-ebe587a2d836 | salesforceid_12 | p12_list     | p12_list     | http://www.snapshot.travel | p12@tenants.biz | true           | Europe/Prague |
      | f7c51321-1dde-4d98-a999-35a3b6379196 | salesforceid_13 | p13_list     | p13_list     | http://www.snapshot.travel | p13@tenants.biz | true           | Europe/Prague |
      | 62bcf845-fc26-46fb-9480-7e539c10dbbc | salesforceid_14 | p14_list     | p14_list     | http://www.snapshot.travel | p14@tenants.biz | true           | Europe/Prague |
      | ad7cfddb-ecf3-401d-a93e-d68bc4b4e3da | salesforceid_15 | p15_list     | p15_list     | http://www.snapshot.travel | p15@tenants.biz | true           | Europe/Prague |
      | 6d455567-b952-4503-97de-9c608b6a8c28 | salesforceid_16 | p16_list     | p16_list     | http://www.snapshot.travel | p16@tenants.biz | true           | Europe/Prague |
      | 691a104c-47f4-4dab-9c22-040c00b10c03 | salesforceid_17 | p17_list     | p17_list     | http://www.snapshot.travel | p17@tenants.biz | true           | Europe/Prague |
      | 202ed76e-e3c4-4359-9461-b4ccb7cb9a20 | salesforceid_18 | p18_list     | p18_list     | http://www.snapshot.travel | p18@tenants.biz | true           | Europe/Prague |
      | 98b50129-72f8-4b55-af15-9507db2cca95 | salesforceid_19 | p19_list     | p19_list     | http://www.snapshot.travel | p19@tenants.biz | true           | Europe/Prague |
      | d94a9119-6936-466c-8cfd-693acebd39ac | salesforceid_20 | p20_list     | p20_list     | http://www.snapshot.travel | p20@tenants.biz | true           | Europe/Prague |
    Given The following commercial subscriptions exist
      | commercialSubscriptionId             | customerId                           | propertyId                           | applicationId                        |
  ...
  #application_version_id, is_active, commercial_subscription_id, api_subscription_id]
    Examples:
      ...
      | api_subscription_id=='*359'                                    | commercial_subscription_id | /null                      | 5        | 17eb138c-23c1-43d8-bc88-d6fbbd7e4359, 27eb138c-23c1-43d8-bc88-d6fbbd7e4359, 37eb138c-23c1-43d8-bc88-d6fbbd7e4359, 47eb138c-23c1-43d8-bc88-d6fbbd7e4359, a7eb138c-23c1-43d8-bc88-d6fbbd7e4359                                       |
      ...
      | api_subscription_id=='*359'                                    | /null                      | commercial_subscription_id | 5        | a7eb138c-23c1-43d8-bc88-d6fbbd7e4359, 47eb138c-23c1-43d8-bc88-d6fbbd7e4359, 37eb138c-23c1-43d8-bc88-d6fbbd7e4359, 27eb138c-23c1-43d8-bc88-d6fbbd7e4359, 17eb138c-23c1-43d8-bc88-d6fbbd7e4359                                       |
      ...
      | /null                                                          | commercial_subscription_id | /null                      | 6        | 17eb138c-23c1-43d8-bc88-d6fbbd7e4359, 27eb138c-23c1-43d8-bc88-d6fbbd7e4359, 37eb138c-23c1-43d8-bc88-d6fbbd7e4359, 47eb138c-23c1-43d8-bc88-d6fbbd7e4359, 5c6f61ff-810c-43da-96e2-ff6c8c9b8b2f, a7eb138c-23c1-43d8-bc88-d6fbbd7e4359 |
