Feature: facebook_posts
  ...
  Scenario Outline: Getting a list of items
    ...
    Examples: 
      ...
      | /social_media/analytics/facebook/posts |       |        | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | /null |        | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts |       | /null  | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | /null | /null  | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | 51    |        | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | 51    | /null  | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts |       | 1      | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | /null | 1      | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | 20    | 0      | 20    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | 60    | 0      | 50    | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
      | /social_media/analytics/facebook/posts | 5     | 5      | 5     | 99999999-9999-4999-a999-999999999999 | 200           | application/json | facebook   |
