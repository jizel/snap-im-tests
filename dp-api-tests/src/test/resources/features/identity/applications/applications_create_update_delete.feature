...
Feature: Applications create update delete
  ...
  Scenario: Create get delete application
    When Application is created
      ...
      | Application test company 1 | Application description 1 | http://www.snapshot.travel | 07000000-0000-4444-8888-000000000002 | abc8fd9a-a05d-42d8-8e84-42e904ace123 | false      |
  ...
  Scenario Outline: Checking error codes for creating applications
    Given Application is created
      ...
      | Application test company 1 | Application description 1 | http://www.snapshot.travel | 07000000-0000-4444-8888-000000000002 |
  ...
  Scenario: Updating application with outdated etag
    Given The following applications exist
      ...
      | a318fd9a-a05d-42d8-8e84-42e904ace123 | Application test company 1 | Application description 1 | http://www.snapshot.travel | 07000000-0000-4444-8888-000000000002 |
  ...
  Scenario: Application ID and name is unique when creating role - DP-1661
    Given The following applications exist
      ...
      | App Name 1      | Original application | http://www.snapshot.travel | 00011222-a05d-42d8-8e84-42e904ace123 | 07000000-0000-4444-8888-000000000002 | false      |
    When Application is created
      | name            | description            | website                    | id                                   | partnerId                            | isInternal |
      | App Name 2      | Different name same ID | http://www.snapshot.travel | 00011222-a05d-42d8-8e84-42e904ace123 | 07000000-0000-4444-8888-000000000002 | false      |
  ...
  Scenario: Application cannot be deleted when it has application versions
    When The following applications exist
      | id                                   | name                       | description               | website                    | partnerId                            |
      | 00000000-a05d-42d8-8e84-111111111111 | Application test company 1 | Application description 1 | http://www.snapshot.travel | 07000000-0000-4444-8888-000000000002 |
