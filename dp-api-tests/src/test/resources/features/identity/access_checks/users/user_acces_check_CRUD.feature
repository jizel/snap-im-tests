...
Feature: Users can create, update and delete only users of the same customer
  ...
  Background:
    ...
    Given API subscriptions exist for default application and customer with id "12300000-0000-4000-a000-000000000000" and property "11111111-0000-4000-a000-666666666666"
    Given API subscriptions exist for default application and customer with id "12300000-0000-4000-a000-000000000001" and property "11111111-0000-4000-a000-666666666666"
